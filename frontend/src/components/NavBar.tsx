          ...
          <div className={`flex items-center flex-row justify-between w-full gap-3`}>
            ...
            <ul className="flex space-x-4">
              {['About', 'Demo', 'Pricing', 'Reviews'].map((item, index) => (
                <li key={item}>
                  <Link href="#" passHref className={`text-gray-700 font-medium ${selectedIndex === index ? 'border-b-2 border-blue-500' : ''
                    }`}
